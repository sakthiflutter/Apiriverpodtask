...
//
//     final repomodeldata = repomodeldataFromJson(jsonString);

import 'dart:convert';

Repomodeldata repomodeldataFromJson(String str) => Repomodeldata.fromJson(json.decode(str));

String repomodeldataToJson(Repomodeldata data) => json.encode(data.toJson());
...
class Repomodeldata {
  ...
  factory Repomodeldata.fromJson(Map<String, dynamic> json) => Repomodeldata(
...
final defaultBranchValues = EnumValues({
  ...
  "open-project": DefaultBranch.OPEN_PROJECT
});
